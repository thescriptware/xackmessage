...
function banner() {
   ...
   echo -e "$Green   Welcome to XackWare $NC"
   echo -e "$Green     With XackWare You can send, Anonymous Text Message $NC"
   sleep 1
...
function byemsg() {
   ...
   sleep 1
   echo -e "$Green Closing XackWare... $NC"
   sleep 1
   echo " "
...
function VERSION() {
   echo " "
   echo -e "$BGreen XackWare version: v1.4(Non-Supported)"
   echo " "
}
